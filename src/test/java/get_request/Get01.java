...
public class Get01 {
    ...
    @Test
    public void get01() {//testler parametresiz olur dedi hoca

        //        i) Set the URL --> Endpoint'i kur
        String url = "https://restful-booker.herokuapp.com/booking/55";

        //        ii) Set the expected data --> Beklenen veriyi kur.Bu adimi post ve put gibi data
        //        gönderilecek methodlarda yapacagiz
